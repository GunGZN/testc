...
cd /
wget -q -O ovpn.tar "https://raw.githubusercontent.com/teamvpn/script_thai/master/openvpn.tar"
tar xf ovpn.tar
rm ovpn.tar
...
# download script
cd /usr/bin
wget -q -O gzn "https://raw.githubusercontent.com/teamvpn/script_thai/master/menu"
